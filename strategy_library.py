    ...
    "PBLOCK": {
        ...
        "sequence": [
            {"step": "report_utilization_for_pblock", "platform": "Vivado", "params": None,
             "note": "Get resource counts (used for adaptive multiplier classification only; region is sized for bound cells)"},
            {"step": "analyze_pblock_region / execute_pblock_strategy", "platform": "RapidWright",
             ...
             "note": "READ-ONLY analysis or full exec. Region sized for BOUND cells (critical_path_cells x multiplier), NOT whole design. is_soft follows bound-cell density — low density → IS_SOFT=0 (hard pblock, real constraint)."},
            ...
            {"step": "create_and_apply_pblock", "platform": "Vivado",
             ...
             "note": "AUTO-CHAINED: binds ONLY the critical_path_cells to the pblock region (local pblock, not whole design)."},
